...
def can_be_found_updated_and_saved
  ...
  b = Movie.find_by(title: "Awesome Flick")
  b.title = "Even Awesomer Flick"
  b.save
...
def can_update_using_update_method
  ...
  b = Movie.create(title: "Wat?")
  b.update_columns(title: "Wat, huh?")
  b
end
...
def can_update_multiple_items_at_once
  ...
  # Movie.all.each{|m| m.update_columns(title: "Wat, huh?")}
  Movie.update(title: "A Movie")
end

def can_destroy_a_single_item
  Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  b = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  Movie.destroy(b.id)
end
